...
return [
    ...
    */
    'managers'                   => [
        'default' => [
            ...
            'repository'    => \App\Doctrine\EntityRepository::class,
            'proxies'       => [
                'namespace'     => false,
                'path'          => storage_path('proxies'),
                'auto_generate' => env('APP_DEBUG', false)
            ],
            'naming_strategy' => \LaravelDoctrine\ORM\Configuration\LaravelNamingStrategy::class,
    ...
    */
    'custom_types'               => [
        ...
        'phonenumber' => \App\Doctrine\Types\PhoneNumber::class,
    ],
